...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { description: @community.description, name: @community.name, notes: @community.notes, zone_id: @community.zone_id }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { description: @community.description, name: @community.name, notes: @community.notes, zone_id: @community.zone_id }
    assert_redirected_to community_path(assigns(:community))
  end
